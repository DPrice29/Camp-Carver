...
public class OrionStarShuffle : MonoBehaviour
{
    ...
    void Start(){
        ...
        StarSlots.Add(GameObject.Find("Location Trigger 8").GetComponent<Collider2D>());
        StarSlots.Add(GameObject.Find("Location Trigger 9").GetComponent<Collider2D>());
        StarSlots.Add(GameObject.Find("Location Trigger 10").GetComponent<Collider2D>());
        StarSlots.Add(GameObject.Find("Location Trigger 11").GetComponent<Collider2D>());
        StarSlots.Add(GameObject.Find("Location Trigger 12").GetComponent<Collider2D>());
        StarSlots.Add(GameObject.Find("Location Trigger 13").GetComponent<Collider2D>());
        StarSlots.Add(GameObject.Find("Location Trigger 14").GetComponent<Collider2D>());
        StarSlots.Add(GameObject.Find("Location Trigger 15").GetComponent<Collider2D>());
        StarSlots.Add(GameObject.Find("Location Trigger 16").GetComponent<Collider2D>());
    ...
    private void OnMouseUp(){
        ...
        foreach(Collider2D StarSlot in StarSlots){
            if(StarSlot.OverlapPoint(transform.position)){
                ...
                transform.position = new Vector3(SlotCenter.x, SlotCenter.y, transform.position.z);
